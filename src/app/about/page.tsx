...
export default function AboutPage() {
  return <>
    ...
    <section className="section"><div className="container"><SectionHeading eyebrow="The builder" title="Built by Dairus Okoh"/><div className="card"><p>SpillFlare was built by Dairus Okoh as an independent public-interest data platform for exploring Nigeria&apos;s oil-spill and gas-flare records.</p><p>Dairus is open to collaborations with journalists, researchers, civil-society organisations, developers, and others working with environmental or public-interest data.</p><p>For information, enquiries, data questions, or collaboration, contact <a className="text-link" href="mailto:okohdairus@gmail.com">okohdairus@gmail.com</a>.</p></div></div></section>
  </>;
}
